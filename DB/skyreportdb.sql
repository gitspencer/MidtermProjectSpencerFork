...
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `enabled`, `role`, `location_id`, `date_created`, `last_update`, `about_me`, `profile_picture_url`) VALUES (2, 'tiawright', '1234', 'Tia', 'Wright', 1, 'USER', 3, '2023-05-19', '2023-05-19', 'Indiana based Java developer', 'https://media.licdn.com/dms/image/D5603AQErCoxlVpTI0Q/profile-displayphoto-shrink_800_800/0/1681660649328?e=1690416000&v=beta&t=TZsS5o0FhL9YU6IqEQ9rRlbtWXFzbW271_ZEVVH281Q');
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `enabled`, `role`, `location_id`, `date_created`, `last_update`, `about_me`, `profile_picture_url`) VALUES (3, 'jacobvan', '1234', 'Jacob', 'Van', 1, 'USER', 5, '2023-05-19', '2023-05-19', 'North Carolina based Java developer', 'https://media.tenor.com/images/a2e5cfed5ec322b50d78bb0330d98be9/tenor.png');
INSERT INTO `user` (`id`, `username`, `password`, `first_name`, `last_name`, `enabled`, `role`, `location_id`, `date_created`, `last_update`, `about_me`, `profile_picture_url`) VALUES (4, 'nickspeidell', '1234', 'Nick', 'Speidell', 1, 'USER', 4, '2023-05-19', '2023-05-19', 'Colorado based Java developer', 'https://media.licdn.com/dms/image/D5603AQFnfnstIRLQPg/profile-displayphoto-shrink_800_800/0/1683219317851?e=2147483647&v=beta&t=GxarqeIAnbr0uzQ-mgQNhPPRTFXwcRsfkTZNw5-1dWE');
...
START TRANSACTION;
USE `skyreportdb`;
INSERT INTO `sighting` (`id`, `enabled`, `user_id`, `location_id`, `known_object_id`, `sighting_date`, `title`, `description`, `date_created`, `picture_url`, `last_update`) VALUES (1, 1, 1, 2, 1, '1947-06-26', 'Roswell incident', 'Found debris – tinfoil, rubber, and thin wooden beams – scattered across a square mile of desert.', '2023-05-18', 'https://libraries.uta.edu/sites/default/files/styles/2_grid_width/public/2019-07/general-ramey.png?itok=a2oi0uS5', '2023-05-18');
INSERT INTO `sighting` (`id`, `enabled`, `user_id`, `location_id`, `known_object_id`, `sighting_date`, `title`, `description`, `date_created`, `picture_url`, `last_update`) VALUES (2, 1, 4, 7, NULL, '2001-07-14', 'Lights Above New Jersey Turnpike', 'Strange orange-and-yellow lights in a V formation over the Arthur Kill Waterway between Staten Island, New York, and Carteret, New Jersey.', '2023-05-19', 'https://www.researchgate.net/profile/Vinh-Nguyen-30/publication/329403022/figure/fig7/AS:700194383482880@1543950758025/A-YouTube-screen-shot-of-the-UFO-formation-on-July-15-2001-at-Turnpike-road-Carteret.ppm', '2023-05-19');
INSERT INTO `sighting` (`id`, `enabled`, `user_id`, `location_id`, `known_object_id`, `sighting_date`, `title`, `description`, `date_created`, `picture_url`, `last_update`) VALUES (3, 1, 3, 8, NULL, '2015-01-01', 'East Coast GO FAST', 'Seen along the East Coast on a Raytheon Advanced Targeting Forward-Looking Infrared (ATFLIR) Pod, the craft was similar to that spotted off San Diego in 2004: a fast-moving white oval about 45-feet-long without wings or exhaust plume. \n\nThe pilots tracked the object at 25,000 feet above the Atlantic Ocean as it flew away and simultaneously rotated on its axis. No explanation ever emerged.\n\n', '2023-05-19', 'https://www.navytimes.com/resizer/97FTDT6oyEkt2PalZsOlCk7wKaw=/1024x0/filters:format(png):quality(70)/cloudfront-us-east-1.images.arcpublishing.com/archetype/7HWSGU2RDFCMLJ6K24SDEIT54A.png', '2023-05-19');
INSERT INTO `sighting` (`id`, `enabled`, `user_id`, `location_id`, `known_object_id`, `sighting_date`, `title`, `description`, `date_created`, `picture_url`, `last_update`) VALUES (4, 1, 2, 9, 2, '1995-07-23', 'Comet Hale-Bopp', 'Comet Hale–Bopp (formally designated C/1995 O1) is a comet that was one of the most widely observed of the 20th century and one of the brightest seen for many decades.', '2023-05-19', 'https://upload.wikimedia.org/wikipedia/commons/thumb/b/ba/Comet_Hale-Bopp_1995O1.jpg/1280px-Comet_Hale-Bopp_1995O1.jpg', '2023-05-19');
INSERT INTO `sighting` (`id`, `enabled`, `user_id`, `location_id`, `known_object_id`, `sighting_date`, `title`, `description`, `date_created`, `picture_url`, `last_update`) VALUES (5, 1, 5, 10, 3, '2023-03-24', 'Alpena Northern Lights', 'Green and purple lights dancing in sky', '2023-05-19', 'https://www.bridgemi.com/sites/default/files/styles/full_width_image/public/2023-04/northern%20lights%20shutterstock_0.jpg?itok=qZzARzGS', '2023-05-19');
