...
<body>
	...
	<div style="min-height: 100vh" class="background-image">
		...
		<div class="container">
			...
			<div class="textbox">
				<div class="row">
					<form class="col" action="createAccount.do" method="post">
						<fieldset class="items add">
							...
							<label id="six">Address: </label> <input type="text"
								...
								id="eight">State: </label> <input type="text" name="state" /> <br>
							<label id="nine">Country: </label> <input type="text"
								name="country" /> <br> <label id="nine">About Me:
							</label> <input type="text" name="aboutMe" /> <br> <label id="nine">Profile
								Picture: </label> <input type="text" name="profilePictureUrl" /> <br>
